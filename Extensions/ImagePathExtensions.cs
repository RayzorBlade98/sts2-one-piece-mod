...
public static class ImagePathExtensions
{
    ...
    public static string ToEnergyIconPath(this string path)
    {
        return Path.Join(EnergyPath, path);
    }
    
    public static string ToPowerIconPath(this string path)
    {
        return Path.Join(PowerPath, path);
    }
    
    public static string ToBigPowerIconPath(this string path)
    {
